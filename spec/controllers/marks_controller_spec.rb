...
describe MarksController do
  ...
  let(:valid_attributes) { { "marks" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved mark as @mark" do
        ...
        post :create, {:mark => { "marks" => "invalid value" }}, valid_session
        assigns(:mark).should be_a_new(Mark)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested mark" do
        ...
        Mark.any_instance.should_receive(:update).with({ "marks" => "MyText" })
        put :update, {:id => mark.to_param, :mark => { "marks" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the mark as @mark" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Mark.any_instance.stub(:save).and_return(false)
        put :update, {:id => mark.to_param, :mark => { "marks" => "invalid value" }}, valid_session
        assigns(:mark).should eq(mark)
      end
